...
public class UserController {
	...
	@PostMapping("/addUser")
public String addUser(@Valid @ModelAttribute("user") UserModel usermodel,Model m)
	//public String addUser(@ModelAttribute("user") UserModel usermodel,Model m)
	{
...
public String modifyLogic(@Valid @ModelAttribute("user") UserModel usermodel,@RequestParam("corporateId") int id,Model m)
