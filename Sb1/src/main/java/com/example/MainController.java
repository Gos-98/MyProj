...
public class MainController {
	...
	public String Login(@RequestParam("userLoginId") String username,@RequestParam("userPassword") String password,@ModelAttribute("user") UserModel userm,Model m)
	{
...
public String addCorporate(@Valid @ModelAttribute("corporate") CorporateModel cm) {
...
public String modifybtn(@Valid @ModelAttribute("Corpmodify") CorporateModel cmodel) {
